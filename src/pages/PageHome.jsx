      ...
      <div>
        ...
        <div className="max-w-md mx-auto my-20 p-4 bg-white shadow-md rounded-md">
          ...
          >
            ...
            {loader ? <p className="text-center">Buscando...</p> : worker ? <WorkerDetails worker={worker} loader={loader} />
              : <p className="text-center">No se ha encontrado información</p>}
          </div>
          <div className="flex justify-center">
            {worker && !worker?.date_attendance && <Button event={handleCheckInBtn}>Marcar hora de entrada</Button>}
            {worker?.date_attendance_string && worker?.check_out_string === null && <Button event={handleCheckOutBtn}>Marcar hora de salida</Button>}
          </div>
          {checkInSuccess && (
